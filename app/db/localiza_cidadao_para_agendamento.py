...
def buscar_notificacao_base_servico(
    ...
    Essa notificação-base é a melhor candidata para ser enviada
    depois à API de agendamento, pois já carrega o contexto do serviço.
    """
    prontuariogapd_norm = prontuariogapd.strip() if prontuariogapd else None
    telefone_norm = normalizar_somente_digitos(telefone)
    servico_norm = servicoespecializado.strip()
